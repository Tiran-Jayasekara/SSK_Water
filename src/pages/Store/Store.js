...
return (
  <>
    ...
    <Col className='Store_Nav_Bar' xs={{ span: 22 }} sm={{ span: 24 }} lg={{ span: 6 }}>
    <Row gutter={0}>
      <Col className='Store_Nav_Bar' xs={{ span: 4 }} sm={{ span: 4 }} lg={{ span: 24 }}>
    ...
    <Col className='Store_product_List' xs={{ span: 24 }} sm={{ span: 24 }} lg={{ span: 18 }}>
